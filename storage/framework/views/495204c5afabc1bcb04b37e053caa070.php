<?php $__env->startSection('title', 'Informasi APBDes'); ?>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
                <div class="text-center">
                    ...
                    <!-- Year Filter -->
                    <div class="mt-8">
                        <form id="tahunForm" action="<?php echo e(route('front.apbdes')); ?>" method="GET"
                            ...
                            <select name="tahun" id="tahun"
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $tahunTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e($tahun); ?>" <?php echo e($tahun == $tahunAnggaran ? 'selected' : ''); ?>>
                                        <?php echo e($tahun); ?>
                ...
                <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <?php $__empty_1 = true; $__currentLoopData = $sumberPendapatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sumber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div
                                        class="flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-colors duration-150">
                                        <span class="text-sm text-gray-600"><?php echo e($sumber->sumber_dana); ?></span>
                                        <span class="text-sm font-medium text-gray-900">Rp
                                            <?php echo e(number_format($sumber->total, 0, ',', '.')); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <?php $__empty_1 = true; $__currentLoopData = $jenisBelanja; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $belanja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div
                                        class="flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-colors duration-150">
                                        <span class="text-sm text-gray-600"><?php echo e($belanja->sub_kategori); ?></span>
                                        <span class="text-sm font-medium text-gray-900">Rp
                                            <?php echo e(number_format($belanja->total, 0, ',', '.')); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="mt-8">
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <?php $__empty_1 = true; $__currentLoopData = $jenisPembiayaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembiayaan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div
                                        class="flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-colors duration-150">
                                        <span class="text-sm text-gray-600"><?php echo e($pembiayaan->sub_kategori); ?></span>
                                        <span class="text-sm font-medium text-gray-900">Rp
                                            <?php echo e(number_format($pembiayaan->total, 0, ',', '.')); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__empty_1 = true; $__currentLoopData = $programPendapatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                <?php echo e($program->nama_program); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo e($program->sub_kategori); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Rp
                                                <?php echo e(number_format($program->pagu_anggaran, 0, ',', '.')); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Rp
                                                <?php echo e(number_format($program->realisasi_anggaran, 0, ',', '.')); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                                                        <div class="bg-lime-600 h-2.5 rounded-full"
                                                            style="width: <?php echo e($program->persentase_realisasi); ?>%"></div>
                                                    </div>
                                                    <span
                                                        class="ml-2 text-sm text-gray-500"><?php echo e(number_format($program->persentase_realisasi, 1)); ?>%</span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <?php switch($program->status_realisasi):
                                                    case ('Selesai'): ?>
                                                        <span
                        ...
                        <div class="mb-12">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__empty_1 = true; $__currentLoopData = $programBelanja; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    <?php echo e($program->nama_program); ?></td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            ...
                            <div class="mb-12">
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <?php $__empty_1 = true; $__currentLoopData = $programPembiayaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                        <?php echo e($program->nama_program); ?></td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u454891112/domains/desa-pamuruyan.id/public_html/resources/views/front/apbdes.blade.php ENDPATH**/ ?>