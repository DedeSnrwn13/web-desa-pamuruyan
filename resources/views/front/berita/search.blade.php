        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Hasil Pencarian</h1>
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        @forelse ($beritas as $berita)
                            <div
                                class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden hover:ring-2 hover:ring-lime-500 transition-all duration-300">
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="text-sm font-medium text-gray-900">{{ $berita->admin->name }}</span>
                        ...
                        @empty
                            <div class="col-span-3 text-center py-12">
                                ...
                                <h3 class="mt-2 text-sm font-semibold text-gray-900">Tidak ada hasil</h3>
                                <p class="mt-1 text-sm text-gray-500">Tidak ditemukan berita yang sesuai dengan kata kunci
                                    "{{ $keyword }}".</p>
                                <div class="mt-6">
                                    <a href="{{ route('front.berita.index') }}"
                                        class="text-sm font-semibold text-lime-600 hover:text-lime-500">
