                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        @empty
                            <div class="col-span-3 text-center py-12">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Tidak ditemukan berita yang sesuai dengan kata kunci "{{ $keyword }}".</p>
                                <div class="mt-6">
                                    <a href="{{ route('front.berita.index') }}" class="text-sm font-semibold text-lime-600 hover:text-lime-500">
