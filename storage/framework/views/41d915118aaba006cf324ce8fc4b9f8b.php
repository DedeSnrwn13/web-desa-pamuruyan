...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Website Resmi Desa Pamuruyan</title>
    <meta name="description"
        content="<?php echo e($description ?? 'Website resmi Pemerintah Desa Pamuruyan. Sarana informasi dan komunikasi digital untuk warga desa dan masyarakat umum.'); ?>">

    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo e(public_asset('images/favicon.ico')); ?>" type="image/x-icon">

    <!-- Tailwind CSS -->
    
    <link rel="stylesheet" href="<?php echo e(public_asset(Vite::asset('resources/css/app.css'))); ?>">
    ...
    <header class="bg-white shadow-md z-20 relative" x-data="{ mobileMenuOpen: false, searchOpen: false }">
        <div class="container mx-auto px-4 md:px-6">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="<?php echo e(route('front.index')); ?>" class="flex items-center">
                        <img src="<?php echo e(public_asset('images/logo-kab-sukabumi.png')); ?>" alt="Logo Desa" class="h-12 w-auto mr-3">
                        <div>
                ...
                <nav class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="<?php echo e(route('front.galeri', ['tab' => 'semua'])); ?>"
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    <?php if(Auth::check()): ?>
                        <a href="<?php echo e(route('filament.warga.pages.dashboard')); ?>"
        ...
        <div x-show="mobileMenuOpen" x-cloak class="md:hidden bg-white border-t" x-transition>
            <div class="container mx-auto px-4 py-3 space-y-1">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block py-2 text-lime-600 font-medium">Login</a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div x-show="searchOpen" x-cloak class="fixed inset-0 z-50 bg-black bg-opacity-30"
            ...
            <div class="h-full flex items-center justify-center p-4">
                <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl">
                    <form action="<?php echo e(route('front.berita.cari')); ?>" method="GET">
    ...
    <footer class="bg-lime-900 text-white">
        <div class="container mx-auto px-4 md:px-6 py-12">
            ...
            <div class="mt-12 pt-8 border-t border-lime-800 text-center">
                <p class="text-lime-100">&copy; <?php echo e(date('Y')); ?> Desa Pamuruyan - Kecamatan Cibadak.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/u454891112/domains/desa-pamuruyan.id/public_html/resources/views/layouts/main.blade.php ENDPATH**/ ?>