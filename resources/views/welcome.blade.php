            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="text-center">
                    <div
                        ...
                        <img src="{{ asset('images/pengurus/kades.jpg') }}" alt="Kepala Desa"
                ...
                <div class="text-center">
                    <div
                        ...
                        <img src="{{ asset('images/pengurus/sekdes.jpg') }}" alt="Sekretaris Desa"
                            class="w-full h-full object-cover">
                    </div>
                ...
                <div class="text-center">
                    <div
                        class="relative mb-4 mx-auto w-40 h-40 rounded-full overflow-hidden border-4 border-lime-500 shadow-md">
                        <img src="{{ asset('images/pengurus/bendahara.jpg') }}" alt="Bendahara Desa"
                            class="w-full h-full object-cover">
                    </div>
                ...
                <div class="text-center">
                    <div
                        class="relative mb-4 mx-auto w-40 h-40 rounded-full overflow-hidden border-4 border-lime-500 shadow-md">
                        <img src="{{ asset('images/pengurus/kaur.jpg') }}" alt="Kaur Perencanaan"
                            class="w-full h-full object-cover">
                    </div>
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="hidden lg:block">
                    <img src="{{ asset('images/visi-misi.svg') }}" alt="Visi Misi" class="w-full max-w-md mx-auto">
                </div>
            </div>
        </div>
    </section>
